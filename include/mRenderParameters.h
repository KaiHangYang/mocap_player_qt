...
static glm::mat4 m_cam_in_mat_ortho = glm::transpose(glm::ortho(-mWindowWidth / 17.0f, mWindowWidth / 17.0f, -mWindowHeight / 17.0f, mWindowHeight / 17.0f, -500000.f, 500000.f));
